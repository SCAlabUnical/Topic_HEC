...
def coherence_lsa(clean_text,start, stop, step,num_words):
    """
    ...
    for val in tipo:
        ...
        for i in range(0,10):
            ...
            for num_topics in range(start, stop, step):
                model = LsiModel(corpus, num_topics, id2word = dictionary)  # train model
...
def topic_diversity_lsa(name_w2v_model,clean_text,start, stop, step,num_words):
    """
